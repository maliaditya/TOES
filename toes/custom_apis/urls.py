...
from .worker_details_views  import display_by_category, display_all, get_specific_worker_details,display_all_withoutsmartphone
...
urlpatterns =[
    ...
    #Template
    path("reset_password/<int:phone>", passreset , name="reset"),
